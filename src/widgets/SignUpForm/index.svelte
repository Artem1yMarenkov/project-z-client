<script lang="ts">
  ...
  import { regSchema } from "../../shared/utils/schema.ts";
  import src from "../../shared/assets/logo.svg";
  import type { ISignUpValumes } from "./types";

  let values: ISignUpValumes = {} as ISignUpValumes;
...
<div class="h-4/6 w-3/6">
  ...
  <h1 class="text-4xl font-sans font-semibold mb-6">Регистрация</h1>
